...
module.exports = function (webpackEnv) {
    ...
    return {
        ...
        // In dev, webpack-dev-server auto-injects its own client + webpack/hot/dev-server
        // when `hot: true` is set in the dev-server config, so we don't need to add them
        // here manually (doing so produces a second WebSocket connection because the
        // auto-injected client has different query params).
            ...
            rules: [
                {
                    ...
                    oneOf: [
                        ...
                        // "asset/resource" module makes sure those assets get served by WebpackDevServer.
        ...
        plugins: [
            ...
            // webpack-dev-server auto-applies HotModuleReplacementPlugin when `hot: true`
            // is set in the dev-server config, so we don't add it manually here.
            // (Adding it manually triggers a WDS v5 warning.)
...
class HTML2PugPlugin {
    constructor(htmlPath) {
        this.name = "HTML2Pug"
        this.htmlPath = htmlPath || ""
        this.stage = "afterEmit"
    }
