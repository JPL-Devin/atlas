...
// Note: While this seems duplicative of that in facets/FacetBuilder.js, this tree is generated by
// the first result of the existing search query -- not simply the schema _mapping as a whole
const makeTree = (mapping, activeColumnFields, filterString, setSelected, addRemoveColumn) => {
                ...
                tree.push(
                    <StyledTreeItem
                        ...
                        label={
                            <LabelsTreeLabel
                                id={iter[i]}
                                active={activeColumnFields.includes(nextPath)}
                                label={iter[i]}
                                onCheck={() => {
                                    addRemoveColumn(
                                        nextPath,
                                        !activeColumnFields.includes(nextPath)
                                    )
                                }}
                                onInfoClick={() => {
                                    setSelected({
