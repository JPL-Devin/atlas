...
const LonLatGrid = styled(Grid)({
  width: "100%",
  height: "100%",
  maxHeight: 55
});

const FlipIcon = styled(AutorenewIcon)({
  transform: "scaleY(-1)"
});

const OvalShape = styled("i")({
  width: 16,
  height: 10,
  borderRadius: "50%",
  border: "2px solid",
          ...
          <div id="lonLatRange">
            ...
            >
              <StyledToggleButton id="consoleLon180Btn" value={180}>
                ...
                <ButtonText>180&deg;</ButtonText>
              </StyledToggleButton>
              <StyledToggleButton id="consoleLon360Btn" value={360}>
                <AddBoxIcon fontSize="small" />
                <ButtonText>360&deg;</ButtonText>
              </StyledToggleButton>
            </StyledToggleButtonGroup>
          </div>
        </StyledTooltip>
